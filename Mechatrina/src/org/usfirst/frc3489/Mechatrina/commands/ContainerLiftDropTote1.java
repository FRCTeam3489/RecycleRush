 ...
 *
 */
public class ContainerLiftDropTote1 extends Command {
    ...
    protected void initialize() {
    	...
    	goal = GlobalVariables.eggDROPTOTE1; //goal/destination lift is heading towards
    }
