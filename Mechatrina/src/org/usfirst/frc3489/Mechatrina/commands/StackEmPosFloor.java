 ...
 *
 */
public class StackEmPosFloor extends Command {

    public StackEmPosFloor() {
    ...
    protected void execute() {
    	...
    	if (volt < GlobalVariables.posFLOORUPPER) {
    		//Robot.stackEm.stackerDown();
    		Robot.globalVariables.toteDown = true;
    	} else if (volt > GlobalVariables.posFLOORLOWER){
    ...
    protected boolean isFinished() {
    	...
    	if(Robot.globalVariables.OverrideStop==true){
    		...
    		Robot.globalVariables.toteDown = false;
    		return true;
    	} else if(spoty < GlobalVariables.posFLOORLOWER & spoty > GlobalVariables.posFLOORUPPER){
        	Robot.globalVariables.intakeSolenoidsUsable = true;
    		Robot.globalVariables.toteUp = false;
    		Robot.globalVariables.toteDown = false;
    		return true;
