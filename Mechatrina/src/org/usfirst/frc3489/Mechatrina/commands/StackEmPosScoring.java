 ...
 *
 */
public class StackEmPosScoring extends Command {

    public StackEmPosScoring() {
    ...
    protected void execute() {
    	...
    	if (volt < GlobalVariables.posSCORINGUPPER) {
    		//Robot.stackEm.stackerDown();
    		Robot.globalVariables.toteDown = true;
    	} else if (volt > GlobalVariables.posSCORINGLOWER){
    ...
    protected boolean isFinished() {
    	...
    	if(Robot.globalVariables.OverrideStop==true){
    		...
    		Robot.globalVariables.toteDown = false;
    		return true;
    	} else if(spoty < GlobalVariables.posSCORINGLOWER & spoty > GlobalVariables.posSCORINGUPPER){
        	Robot.globalVariables.intakeSolenoidsUsable = true;
    		Robot.globalVariables.toteUp = false;
    		Robot.globalVariables.toteDown = false;
    		return true;
