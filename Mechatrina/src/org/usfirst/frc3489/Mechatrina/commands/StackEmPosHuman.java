 ...
 *
 */
public class StackEmPosHuman extends Command {

    public StackEmPosHuman() {
    ...
    protected void execute() {
    	...
    	if (volt < GlobalVariables.posHUMANUPPER) {
    		//Robot.stackEm.stackerDown();
    		Robot.globalVariables.toteDown = true;
    	} else if (volt > GlobalVariables.posHUMANLOWER){
    ...
    protected boolean isFinished() {
    	...
    	if(Robot.globalVariables.OverrideStop==true){
    		...
    		Robot.globalVariables.toteDown = false;
    		return true;
    	} else if(spoty < GlobalVariables.posHUMANLOWER & spoty > GlobalVariables.posHUMANUPPER){
        	Robot.globalVariables.intakeSolenoidsUsable = true;
    		Robot.globalVariables.toteUp = false;
    		Robot.globalVariables.toteDown = false;
    		return true;
